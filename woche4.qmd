...
**$H_0$**: Es besteht eine Assoziation zwischen dem Body-Mass-Index (BMI) und dem Auftreten von Typ-2-Diabetes bei Pima-Indianerinnen.
...
- **Diabetesstatus**: Dichotome Variable (0 = kein Diabetes, 1 = Diabetes)
